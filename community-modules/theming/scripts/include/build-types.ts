...
export const generateDocsFile = async () => {
    ...
    for (const [exportName, unit] of Object.entries(mainExports)) {
        if (unit instanceof ThemeUnit) {
...
const getPartParams = (part: Part): Param[] => Object.keys(part.defaults) as Param[];
